...
//  GolfCourse
//
//  Created by Jacob Osterloh on 4/3/17.
...
class GameViewController: UIViewController {
    ...
    var _level: String = "GameScene"
    var _scene: SKScene?
    var _startScreen: Bool = true
    ...
    override func viewDidLoad() {
        ...
        if let view = self.view as! SKView? {
            ...
            if let scene = GameScene(fileNamed: _level) {
                _scene = scene
...
//            view.showsNodeCount = true
    ...
    func finishedLevel(){
        _player.updateScore(0, score: strokeCount)
    ...
    func setLevelString(_ level: Int){
        switch level {
        case 1:
            _level = "GameScene"
            currentLevel = 1
    ...
    func fromStartScreen(_ startScreen: Bool){
