...
//  GolfCourse
//
//  Created by Jacob Osterloh on 4/20/17.
...
class GameViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let view = self.view as! SKView? {
            ...
            if let scene = Level2(fileNamed: _level) {
                _scene = scene
...
//            view.showsNodeCount = true
    ...
    func finishedLevel(){
        _player.updateScore(1, score: strokeCount)
